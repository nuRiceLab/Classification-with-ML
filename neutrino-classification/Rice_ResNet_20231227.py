...
if __name__ == "__main__":
    ...
    new_thing = WeightedSparseCategoricalCrossentropy(class_weight=class_weights)

    # what_am_i = losses.SparseCategoricalCrossentropy(
    output_losses = {
    ...
    "is_antineutrino":  WeightedSCCE(class_weight=class_weights_tensors[5]), # losses.BinaryFocalCrossentropy(apply_class_balancing=False, alpha=0.8)# ,'binary_crossentropy', 
    }
