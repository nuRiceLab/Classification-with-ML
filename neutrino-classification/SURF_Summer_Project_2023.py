...
model.add(layers.Conv2D(32, (15, 15), activation='relu', data_format="channels_last"))
model.add(layers.AveragePooling2D((2, 2)))
model.add(layers.Conv2D(32, (12, 12), activation='relu', data_format="channels_last"))
model.add(layers.AveragePooling2D((2, 2)))
model.add(layers.Conv2D(64, (9, 9), activation='relu', data_format="channels_last"))
model.add(layers.AveragePooling2D((3, 3)))
model.add(layers.Conv2D(128, (6, 6), activation='relu', data_format="channels_last"))
